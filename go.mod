...
require (
	github.com/Station-Manager/config v0.0.6
	...
	github.com/Station-Manager/logging v0.0.2
)

require (
	github.com/Station-Manager/adapters v0.0.7 // indirect
	github.com/Station-Manager/types v0.0.10 // indirect
	github.com/Station-Manager/utils v0.0.1 // indirect
